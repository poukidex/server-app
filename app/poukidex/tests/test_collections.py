...
from poukidex.schemas import CollectionSchema, ItemSchema, PendingItemSchema
...
class TestCollections(BaseTest):
    ...
    def test_create_collection(self):
        ...
        self.assertDictEqualsSchema(content, CollectionSchema.from_orm(new_collection))
    ...
    def test_retrieve_collection(self):
        ...
        content = response.json()
        self.assertDictEqualsSchema(
            content, CollectionSchema.from_orm(self.first_collection)
        )
    ...
    def test_update_collection(self):
        ...
        self.assertDictEqualsSchema(
            content, CollectionSchema.from_orm(collection_updated)
        )
    ...
    def test_create_item(self):
        ...
        self.assertDictEqualsSchema(
            content,
            ItemSchema.from_orm(Item.objects.get(id=content["id"])),
        )
